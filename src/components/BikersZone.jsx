        ...
        <div className="row gx-0 d-none d-lg-flex" style={{ display: "flex" }}>
          ...
          <div className="col-lg-5 px-5 text-end">
            ...
            <ul className="list-unstyled list-social d-inline-flex mx-n2">
              <li><a href="https://www.facebook.com/bebas.pandey.5"><i className="bi bi-facebook"></i></a></li>
              <li><a href="https://twitter.com/BebasPandey"><i className="bi bi-twitter"></i></a></li>
              <li><a href="https://www.instagram.com/bebaspandey/"><i className="bi bi-instagram"></i></a></li>
